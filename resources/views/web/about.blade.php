    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div class="p-8">
            ...
            <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                AgriConnect was founded with a simple yet powerful vision: to bridge the gap between traditional farming wisdom and modern agricultural technology. We believe that every farmer, regardless of size or experience, deserves access to the tools, knowledge, and resources needed to thrive in today's competitive agricultural landscape.
            </p>
            <p class="text-gray-600 mb-6">
                Our comprehensive platform combines cutting-edge technology with time-tested farming practices, creating solutions that are both innovative and practical. From precision agriculture tools to expert consultation services, we're committed to helping farmers increase productivity, reduce costs, and build sustainable operations for future generations.
            </p>
...
<div class="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg shadow-lg p-8 text-center">
    ...
    <p class="text-xl text-green-100 mb-8">Join thousands of successful farmers who trust AgriConnect for their agricultural needs</p>
