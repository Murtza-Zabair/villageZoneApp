...
@section('title', 'Farming Tips - AgriConnect')
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
    <a href="#crop-cultivation" class="block bg-gradient-to-br from-green-400 to-green-600 text-white rounded-lg p-6 text-center hover:transform hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-green-700">
    ...
    <a href="#water-management" class="block bg-gradient-to-br from-blue-400 to-blue-600 text-white rounded-lg p-6 text-center hover:transform hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-blue-700">
    ...
    <a href="#seasonal-farming" class="block bg-gradient-to-br from-yellow-400 to-yellow-600 text-white rounded-lg p-6 text-center hover:transform hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-yellow-700">
    ...
    <a href="#technology" class="block bg-gradient-to-br from-purple-400 to-purple-600 text-white rounded-lg p-6 text-center hover:transform hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-purple-700">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
                                ...
                                <p class="text-gray-700 text-sm">Test pH levels (6.0-7.0 ideal for most crops), nutrient content, and organic matter percentage before planting.</p>
                            </div>
                            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
                                <h4 class="font-semibold text-green-800 mb-2">2. Organic Matter</h4>
                                <p class="text-gray-700 text-sm">Add compost or well-rotted manure to improve soil structure and fertility. Aim for 3-5% organic matter content.</p>
                            </div>
                            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
                                <h4 class="font-semibold text-green-800 mb-2">3. Tillage Timing</h4>
                                <p class="text-gray-700 text-sm">Till when soil moisture is at field capacity - not too wet or too dry. Follow the "squeeze test" method.</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                                ...
                                <p class="text-gray-700 text-sm">Choose disease-resistant varieties suited to your climate zone. Check germination rates before large-scale planting.</p>
                            </div>
                            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                                <h4 class="font-semibold text-blue-800 mb-2">Spacing & Depth</h4>
                                <p class="text-gray-700 text-sm">Follow recommended spacing for proper air circulation. Plant seeds 2-3 times their diameter deep.</p>
                            </div>
                            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                                <h4 class="font-semibold text-blue-800 mb-2">Succession Planting</h4>
                                <p class="text-gray-700 text-sm">Stagger plantings every 2-3 weeks for continuous harvest throughout the growing season.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600">Water early morning or late evening to reduce evaporation losses</p>
                    </div>
                    <div class="text-center">
                        <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                        ...
                        <p class="text-sm text-gray-600">Water deeply but less frequently to encourage deep root growth</p>
                    </div>
                    <div class="text-center">
                        <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                        ...
                        <p class="text-sm text-gray-600">Use organic mulch to retain soil moisture and reduce watering needs</p>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <ul class="space-y-2 text-sm text-yellow-700">
                        <li><i class="fas fa-check text-yellow-600 mr-2"></i>Install drip irrigation systems for 30-50% water savings</li>
                        <li><i class="fas fa-check text-yellow-600 mr-2"></i>Collect rainwater in tanks or ponds for dry season use</li>
                        <li><i class="fas fa-check text-yellow-600 mr-2"></i>Use moisture sensors to monitor soil water levels</li>
                        <li><i class="fas fa-check text-yellow-600 mr-2"></i>Group plants with similar water requirements together</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Rotate crops annually to break pest and disease cycles</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Plant marigolds, basil, or nasturtiums to repel pests naturally</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Inspect plants weekly for early pest and disease detection</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="bg-orange-50 p-3 rounded-lg">
                                ...
                                <p class="text-sm text-gray-700 mt-1">Encourage ladybugs, lacewings, and parasitic wasps</p>
                            </div>
                            <div class="bg-orange-50 p-3 rounded-lg">
                                <strong class="text-orange-800">Organic Sprays</strong>
                                <p class="text-sm text-gray-700 mt-1">Use neem oil, soap sprays, or diatomaceous earth</p>
                            </div>
                            <div class="bg-orange-50 p-3 rounded-lg">
