...
@section('title', 'Agricultural Healthcare - Village Zone')
...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <a href="#plant-health"
            class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow block focus:outline-none focus:ring-2 focus:ring-green-400">
        ...
        <a href="#livestock-health"
            class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow block focus:outline-none focus:ring-2 focus:ring-blue-400">
        ...
        <a href="#farmer-wellness"
            class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow block focus:outline-none focus:ring-2 focus:ring-purple-400">
        ...
        <a href="#emergency-care"
            class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow block focus:outline-none focus:ring-2 focus:ring-red-400">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Neem oil, copper fungicides, beneficial insects
                                    </p>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div class="mt-6 bg-yellow-50 border-l-4 border-yellow-400 p-4">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-yellow-700">Call our 24/7 hotline: <strong>1-800-VET-HELP</strong>
                                    for urgent livestock emergencies</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Chemical burns, sun exposure, allergic reactions
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="bg-green-50 p-3 rounded-lg">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Proper PPE, safety training, equipment
                                        maintenance</p>
                                </div>
